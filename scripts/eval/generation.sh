...
python generation.py --batch_size 1 --num_workers 8 --save_root ./V_COT_output/ablation_study/ --output_name level2_regularized_DPR_30300EA_CKPT_0000.json --load_ckpt_path checkpoints/level2_regularized_DPR/checkpoint-0000 --eval_tot 300 --gpu_num 0 --USE_DPR True
