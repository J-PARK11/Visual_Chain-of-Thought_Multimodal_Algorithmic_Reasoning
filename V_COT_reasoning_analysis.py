            ...
            if args.VLM_type in ['Idefics2']:
                ...
                exp1_prompt = [
                    {"role": "user",
                     "content": [
                         {"type": "image"},
                         {"type": "text", "text": f'Looking at this image, solve the question.\nQuestion: {question}'}]}
                ...
                exp2_prompt = [
                    {"role": "user",
                     "content": [
                         {"type": "image"},
                         {"type": "text", "text": f'Looking at this image, solve the question and explain how you solved it step-by-step.\nQuestion: {question}'}]}
                    for question in q_stn]
                ...
                exp3_prompt = [
                    {"role": "user",
                     "content": [
                         {"type": "image"},
                         {"type": "text", "text": f'Looking at this image, solve the question and return the bounding box coordinates that are the key to solving the problem.\nQuestion: {question}'}]}
                    for question in q_stn]
                ...
                exp4_prompt = [
                    {"role": "user",
                     "content": [
                         {"type": "image"},
                         {"type": "text", "text": f'Looking at this image and the solving process, answer the question and explain the solution process.\nSolving process: {reasoning["Reasoning_Step"]}\nQuestion: {question}'}]}
                ...
                exp5_prompt = [
                    {"role": "user",
                     "content": [
                         {"type": "image"},
                         {"type": "text", "text": f'Looking at this image and the solving process, answer the question and explain the solution process.\nSolving process: {solution["Answer_Sheet"]}\nQuestion: {question}'}]}
