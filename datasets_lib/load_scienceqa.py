...
def generate_caption(split):
    base_directory = f'/data/SMART101/ScienceQA/captions/{split}'
...
def generate_scienceqa_qainfo(path):
    data_root = path #'/data/SMART101/ScienceQA'
    split = 'train'

    problems, qids = load_data_std(data_root)
    results = []
...
# scienceqa_qa_dict = generate_scienceqa_qainfo(problems)
