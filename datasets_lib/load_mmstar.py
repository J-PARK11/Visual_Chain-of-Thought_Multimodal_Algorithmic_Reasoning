...
def generate_caption():
    base_directory = f'/data/SMART101/MMStar/captions'
...
def generate_mmstar_qainfo(path):
    data_dir = path #'/data/SMART101/MMStar'
    filename = '/data/SMART101/MMStar/MMStar.tsv'
